...
## Code Structure
 ...
 - **`plot_risk_delete_1.m`** &  **`plot_risk_weight_var.m`**: Plot the limiting behavior of out-of-sample risk under equal, random, and variance-penalized weights, respectively.
